"""
Script simplificado: Criar tabela conciliacoes usando DatabaseManager
"""
import sys
import os
...
def criar_tabela_conciliacoes():
    ...
    try:
        # Usar DatabaseManager do próprio sistema (já tem credenciais)
        database = DatabaseManager()
        
        print("\n✅ Conexão estabelecida com sucesso!")
        
        # Usar allow_global=True para operações de schema (sem RLS)
        with database.get_db_connection(allow_global=True) as conn:
